...
namespace ASEFInal
{
    public partial class Form1 : Form
    {
        ...
        private void btnExecute_Click(object sender, EventArgs e)
        {
            ...
            if (txt_command.Text != null && txt_command.Text != "")
            {
                validate = new Validation(txt_command);
        ...
        private void loadCommand()
        {
            ...
            {
                String oneLineCommand = txt_command.Lines[i];
            ...
            {
                String oneLineCommand = txt_command.Lines[loopCounter];
                oneLineCommand = oneLineCommand.Trim();
                if (!oneLineCommand.Equals(""))
                {
            ...
            if (hasEquals)
            {
                ...
                if (firstWord.Equals("if"))
                {
                    ...
                    if (loop)
                    {
                        ...
                        {
                            string oneLineCommand1 = txt_command.Lines[j];
            ...
            else
            {
                if (firstWord.Equals("loop"))
                {
                    ...
                    for (int i = 0; i < counter; i++)
                    {
                        ...
                        {
                            String oneLineCommand = txt_command.Lines[j];
                            oneLineCommand = oneLineCommand.Trim();
                            if (!oneLineCommand.Equals(""))
                            {
                                RunCommand(oneLineCommand);
